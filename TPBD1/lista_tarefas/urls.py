...
urlpatterns = [
    ...
    path("att_tarefa/<int:id_tarefa>/<int:atualizacao>/<str:concluida>", views.att_tarefa, name="att_tarefa"),
    path("atualizar_tarefa/<int:id_tarefa>/<str:descricao>/<str:date>", views.atualizar_tarefa, name="atualizar_tarefa"),
